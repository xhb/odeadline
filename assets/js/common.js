...
function setTheme(theme) {
  ...
  root.style.setProperty('--bg-pic7-url', `url(assets/dooimg/${theme}/home_pic7.svg)`);
  root.style.setProperty('--bg-pic7-768-url', `url(assets/dooimg/${theme}/home_pic7-768.svg)`);
  root.style.setProperty(`--bg-pic1-url`, `url(assets/dooimg/${theme}/${lang}_dow_pic1.png)`);
  root.style.setProperty(`--bg-pic2-url`, `url(assets/dooimg/${theme}/help_pic1.svg)`);
  root.style.setProperty(`--bg-1-url`, `url(assets/dooimg/${theme}/bg1.png)`);
  root.style.setProperty(`--bg-2-url`, `url(assets/dooimg/${theme}/bg2.png)`);
  root.style.setProperty(`--bg-3-url`, `url(assets/dooimg/${theme}/bg3.png)`);
  root.style.setProperty(`--bg-4-url`, `url(assets/dooimg/${theme}/bg4.png)`);
  root.style.setProperty(`--bg-5-url`, `url(assets/dooimg/${theme}/bg5.png)`);
  root.style.setProperty(`--bg-6-url`, `url(assets/dooimg/${theme}/bg6.png)`);
  root.style.setProperty(`--bg-7-url`, `url(assets/dooimg/${theme}/bg7.png)`);
  root.style.setProperty(`--bg-8-url`, `url(assets/dooimg/${theme}/bg8.png)`);
  root.style.setProperty(`--bg-9-url`, `url(assets/dooimg/${theme}/bg9.png)`);
  root.style.setProperty(`--bg-10-url`, `url(assets/dooimg/${theme}/bg10.png)`);
  root.style.setProperty(`--bg-11-url`, `url(assets/dooimg/${theme}/bg11.png)`);
  root.style.setProperty(`--bg-768-3-url`, `url(assets/dooimg/${theme}/bg3_768.png)`);
  root.style.setProperty(`--bg-768-4-url`, `url(assets/dooimg/${theme}/bg4_768.png)`);
  root.style.setProperty(`--bg-768-5-url`, `url(assets/dooimg/${theme}/bg5_768.png)`);
  root.style.setProperty(`--bg-768-6-url`, `url(assets/dooimg/${theme}/bg6_768.png)`);
  root.style.setProperty(`--bg-768-7-url`, `url(assets/dooimg/${theme}/bg7_768.png)`);
  root.style.setProperty(`--bg-768-8-url`, `url(assets/dooimg/${theme}/bg8_768.png)`);
  root.style.setProperty(`--bg-768-9-url`, `url(assets/dooimg/${theme}/bg9_768.png)`);
